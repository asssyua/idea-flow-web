...
export const topicAPI = {
  ...
  addTopicToFavorites: (id: string) => api.post(`/topics/${id}/favorite`),
  removeTopicFromFavorites: (id: string) => api.delete(`/topics/${id}/favorite`),
...
export const ideaAPI = {
  ...
  updateIdea: (ideaId: string, data: any) => api.patch(`/ideas/${ideaId}`, data),
  likeIdea: (ideaId: string) => api.post(`/ideas/${ideaId}/like`),
  dislikeIdea: (ideaId: string) => api.post(`/ideas/${ideaId}/dislike`),
  pinIdea: (ideaId: string) => api.post(`/ideas/${ideaId}/pin`),
  unpinIdea: (ideaId: string) => api.post(`/ideas/${ideaId}/unpin`),
